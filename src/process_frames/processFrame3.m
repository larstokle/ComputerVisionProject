...
if num_inliers >= 15 && abs(rad2deg(theta_est)) <= 10
...
elseif num_inliers >= 8
    ...
    [E,eightp_inlier_mask] = estimateEssentialMatrix_RANSAC_iter(p1_hom,p2_hom,K,K,num_iter_8p_RANSAC);
...
function [E,inlier_mask] = estimateEssentialMatrix_RANSAC_iter(p1, p2, K1, K2, num_iter, costFunction)
...
[F,inlier_mask] = fundamentalEightPoint_RANSAC_iter(p1, p2, num_iter, costFunction);
...
function [F,inlier_mask] = fundamentalEightPoint_RANSAC_iter(p1, p2,num_iter, costFunction)
